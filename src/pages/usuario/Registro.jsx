        ...
        <div className='container  flex w-full'>
            <div className='flex flex-col justify-center items-center lg:w-2/4 mr-10 md:flex-row '>
                ...
                <div className='container'>
                    <h1 className='  font-bold uppercase text-center md:w-2/3 mx-auto'>Registrate y disfruta de los <span className='text-sky-700'>productos</span></h1>
                        { msg &&  <Alerta 
                                alerta={alerta}
                            />
                        }  
                    <form 
                        ...
                        className=' p-2 mx-auto w-96 sm:px-9 mt-8 shadow-md'
                    >
                        <div className='mb-5'>
                            ...
                            <input 
                                ...
                                placeholder='ej: Leonardo Javier Huelvas Borja' 
                                value={nombre}
                        ...
                        <div className='mb-5'>
                            ...
                            <input 
                                ...
                                id="direccion" 
                                className='block placeholder-slate-400 p-2 w-full bg-slate-100' 
                                placeholder='ej: Manzana 9 Casa 25' 
                                value={direccion}
                        ...
                        <div className='mb-5'>
                            ...
                            <input 
                                ...
                                id="web" 
                                className='block placeholder-slate-400 p-2 w-full bg-slate-100' 
                                placeholder='https://github.com/LeonardoHuelvas' 
                                value={web}
